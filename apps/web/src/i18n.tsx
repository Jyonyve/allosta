...
const ko: Record<string, string> = {
  ...
  'Mark overdue reserved consultations as no-shows. This operation is safe to run more than once.':
    '기한이 지난 예약 상담을 노쇼로 처리합니다. 여러 번 실행해도 안전합니다.',
  'Processing…': '처리 중…',
  'Run no-show check': '노쇼 확인 실행',
